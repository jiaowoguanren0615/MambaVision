...
default_cfgs = {
    ...
    'mamba_vision_L2': _cfg(
        url='https://huggingface.co/ahatamiz/mambavision/resolve/main/mambavision_large2_1k.pth.tar',
        crop_pct=1.0,
        input_size=(3, 224, 224),
        crop_mode='center')
}
...
class Attention(nn.Module):
    ...
    def forward(self, x):
        ...
        if self.fused_attn:
            from models.helpers import scaled_dot_product_attention
...
@register_model
def mamba_vision_T(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
...
@register_model
def mamba_vision_T2(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
...
@register_model
def mamba_vision_S(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
...
@register_model
def mamba_vision_B(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
...
@register_model
def mamba_vision_L(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
...
@register_model
def mamba_vision_L2(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
