...
from util.optimizer import SophiaG, AdaFactor, LAMB
...
def get_args_parser():
    parser = argparse.ArgumentParser(
        'MambaVision training and evaluation script', add_help=False)
    ...
    # Model parameters
    parser.add_argument('--model', default='mamba_vision_B', type=str, metavar='MODEL',
                        choices=['mamba_vision_T', 'mamba_vision_T2', 'mamba_vision_S',
...
def main(args):
    ...
    optimizer = LAMB(model_without_ddp.parameters(), lr=args.lr, weight_decay=0.05)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        'MambaVision training and evaluation script', parents=[get_args_parser()])
